...
function TutorDashboard() {
  ...
  return (
    <div className="space-y-8">
      <section className="rounded-3xl border border-slate-200 bg-white p-8 transition-colors dark:border-slate-800 dark:bg-gradient-to-r dark:from-slate-900 dark:via-brand/20 dark:to-slate-900">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            <p className="text-sm uppercase tracking-[0.3em] text-brand-dark dark:text-brand-light">Tutor cockpit</p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-6 py-5 text-sm text-slate-600 transition-colors dark:border-slate-700 dark:bg-slate-900/60 dark:text-slate-300">
            <p>Average rating</p>
            <p className="text-3xl font-bold text-slate-900 dark:text-white">{averageRating.toFixed(1)} ★</p>
            <p className="text-xs text-slate-500 dark:text-slate-500">Completion rate: {completionRate}%</p>
          </div>
        </div>
      </section>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-center transition-colors dark:border-slate-800 dark:bg-slate-900/60">
            <p className="text-sm text-slate-600 dark:text-slate-400">Mentees supported</p>
            <p className="text-3xl font-semibold text-slate-900 dark:text-white">{myStudents.length}</p>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-center transition-colors dark:border-slate-800 dark:bg-slate-900/60">
            <p className="text-sm text-slate-600 dark:text-slate-400">Average rating</p>
            <p className="text-3xl font-semibold text-slate-900 dark:text-white">{averageRating.toFixed(1)} ★</p>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-center transition-colors dark:border-slate-800 dark:bg-slate-900/60">
